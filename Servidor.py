...
class Server():
    ...
    def org_datos(self, x, path):
        # Separar datos.
        # Esta parte es una prueba aca se deberia organizar el manejo de archivo idealmente llamando otros metodos
...
class gestion_servidor:
    ...
    def add_contenido(self, id_bucket, id_contenido, nombre_contenido, contenido):
        self.dicc[id_bucket].add_contenido(
            id_contenido, nombre_contenido, contenido)
